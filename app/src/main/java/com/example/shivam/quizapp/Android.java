...
public class Android extends SQLiteOpenHelper {
        ...
        private static final String Database_name = "Android.db";//NAME of database stored in Assets folder
        private static final String Table_name = "android";//name of table
