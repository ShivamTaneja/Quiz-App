...
public class CoreJava extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.example.shivam.quizapp/databases/";
    private static final String Database_name = "CoreJava.db";//NAME of database stored in Assets folder
    private static final String Table_name = "CoreJava";//name of table
    ...
    public CoreJava(Context context) {//constructor
