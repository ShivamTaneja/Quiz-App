...
public class Cpp extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.example.shivam.quizapp/databases/";
    private static final String Database_name = "Cpp.db";//NAME of database stored in Assets folder
    private static final String Table_name = "Cpp";//name of table
    ...
    public Cpp(Context context) {//constructor
