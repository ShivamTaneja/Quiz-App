...
public class Sql extends SQLiteOpenHelper {
        ...
        private static final String Database_name = "Sql.db";//NAME of database stored in Assets folder
        private static final String Table_name = "Sql";//name of table
    ...
    public Sql(Context context) {//constructor
