...
public class Xml extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.example.shivam.quizapp/databases/";
    private static final String Database_name = "XML.db";//NAME of database stored in Assets folder
    private static final String Table_name = "Xml";//name of table
    ...
    public Xml(Context context) {//constructor
